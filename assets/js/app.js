...
const PAINTINGS = [
  {
    ...
    description: 'An extraordinary, monumental work stretching seven feet in height â a true mural in concept and execution. The eternal love of Radha and Krishna is rendered in three dimensions, with hand-sculpted clay elements emerging from the acrylic base to create a work of astonishing depth and devotional power. Faces, garments, and ornaments rise from the surface, transforming painting into sculpture. This is a centrepiece for those who seek art that transcends categories and fills a space with divine presence.'
  },
  {
    id: 2,
